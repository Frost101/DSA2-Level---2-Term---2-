...
int main()
{
    ...
    for(int i=0; i<N; i++){
        if(league.wins[i] + league.left[i] < maxWin){
            ...
            vector<int> certifiedTeams = maxFlow.edmondsKarp();
